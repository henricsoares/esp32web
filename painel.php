                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="?pagina=esp32">ESP32</a></li>
                                            <!--<li><a href="#">...</a></li>-->
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="?pagina=minhaconta">Account</a></li>
                                            <!--<li><a href="#">...</a></li>-->
                                            <li role="separator" class="divider"></li>
                                            <li><a href="logout.php" onclick="return confirm('Deseja realmente sair?');">Logout</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div><!-- /.navbar-collapse -->
